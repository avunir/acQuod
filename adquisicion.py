...
def calculo_hash(disco):
   ...
   | (_| | | (__  | |__| | | |_| | | (_) | | (_| |
    ...
    while True:
        ...
        print(Fore.CYAN + "1. Proceso automático completo, copiado y cálculo de hashes (md5 y sha256). Este proceso")
        print(Fore.CYAN + "2. Calcular MD5")
        print(Fore.CYAN + "3. Calcular SHA-256")
        print(Fore.CYAN + "4. Calcular SHA-512")        
...
def adquirir_particiones():
    ...
    with open('./info/' + obtener_fecha() + '/disco_seleccionado.txt', 'r') as file:
            for line in file:
                dispositivo_seleccionado.append(line.strip().split()[0])
        """
    ...
    print("\nSeleccione una partición o el disco completo para analizar:")
